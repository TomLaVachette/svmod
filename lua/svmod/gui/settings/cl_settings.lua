net.Receive("SV_Settings", function()
	...
	if data.HasAccess then
		...
		data.StopEngineAfterCrash = net.ReadBool()
		data.StopEngineAfterCrashTime = math.Round(net.ReadFloat(), 2)
		data.StopEngineAfterCrashDamageMultiplier = math.Round(net.ReadFloat(), 2)
